...
-->
  ...
  <div class="row">
	...
	<option value="overo" SELECTED >overo</option>
	<option value="duovero" >duovero</option>
  ...
  <div class="row">
     ...
     <select name="property5value_multi" size=5 multiple onChange="grabImages(this.form.property5value_multi.options)">
        <option value="gumstix-bsp-image" SELECTED >gumstix-bsp-image</option>
        <option value="gumstix-console-image" >gumstix-console-image</option>
        <option value="gumstix-xfce-image" >gumstix-xfce-image</option>
     </select>
  </div>
