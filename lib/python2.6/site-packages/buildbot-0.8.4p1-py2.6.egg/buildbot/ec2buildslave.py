...
class EC2LatentBuildSlave(AbstractLatentBuildSlave):
    ...
    def __init__(self, name, password, instance_type, ami=None,
                 ...
                 aws_id_file_path=None, user_data=None, region='us-west-2',
                 #keypair_name='latent_buildbot_slave',
                 keypair_name='adam-pine',
    ...
    def _start_instance(self):
        ...
        reservation = image.run(
            ...
            instance_type=self.instance_type, user_data=self.user_data, placement='us-west-2c')
        ...
        if self.instance.state == RUNNING:
            ...
            log.msg('%s %s instance %s started on %s '
                    ...
                    (self.__class__.__name__, self.slavename,
                     ...
                     self.output.output))
	    #fabfile.buildbot_slave(self.dns)
	    instance_id = self.instance.id
	    while True:
		try:
		   print "Still trying"
	    	   #fabfile.buildbot_slave(name, self.conn, self.dns, self.instance.id)
	    	   fabfile.buildbot_slave(self.slavename, self.conn, self.dns, instance_id)
		   break
		except Exception:
		   print "Instance not reachable yeat"
		time.sleep(3)
	    #buildbot_start_slave()
